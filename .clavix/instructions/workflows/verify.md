...
When you run `/clavix-verify`, I act as a **Senior Code Reviewer**. I compare _what was built_ against _what was planned_.

1.  **Load the Spec**: I read the `full-prd.md` and `tasks.md` to understand the _requirements_ and _technical design_.
...
2.  **Ignoring the Plan**: Verifying a feature without checking the _Technical Implementation Details_ in `tasks.md`.
