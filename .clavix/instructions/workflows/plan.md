...
**I'm planning strictly _how_ to build it.**
...
_Before reading the PRD, understand the "Team's Coding Method"._
...
2. **Draft Tasks**: Create tasks that specify _exactly_ what to change in the code.
...
- Use `- [ ]` for pending.
- Use `- [x]` for completed.
- **Implementation Note**: The `> **Implementation**` block is REQUIRED. It forces you to think about _where_ the code goes.
