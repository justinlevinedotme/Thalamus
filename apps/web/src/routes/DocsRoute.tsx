      ...
      <div className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
        <div className="max-w-md rounded-lg border border-slate-200 bg-white p-6 text-center">
          ...
          <p className="mt-2 text-sm text-slate-500">
            Cloud documents are available for accounts only. Non-account usage
            is export-only.
          </p>
          <Link
            className="mt-4 inline-flex rounded-md bg-slate-900 px-4 py-2 text-sm text-white"
            to="/login"
          >
            Sign in
          </Link>
    ...
    <div className="min-h-screen bg-slate-50 px-6 py-8">
      <div className="mx-auto max-w-4xl space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-slate-900">Your graphs</h1>
            <p className="text-sm text-slate-500">
              {graphs.length}/20 saved. Each graph keeps a one-year retention
              window.
            </p>
          </div>
          <button
