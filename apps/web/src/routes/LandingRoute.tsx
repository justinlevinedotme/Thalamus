      ...
      <main className="flex-1">
          ...
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-4">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 rounded-md border border-slate-200 px-6 py-3 text-sm font-medium text-slate-700 transition hover:bg-slate-50"
              >
        ...
        <section className="px-6 py-24">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <Link
              to="/editor"
              className="mt-8 inline-flex items-center gap-2 rounded-md bg-slate-900 px-6 py-3 text-sm font-medium text-white transition hover:bg-slate-800"
            >
              Open Editor
              <ArrowRight className="h-4 w-4" />
            </Link>
